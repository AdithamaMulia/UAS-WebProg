...
<body style="background-color: #a4a4a4;">
    <div class="card">
        ...
        <form action="<?php echo e(url('/tambahmurid')); ?>" method="get">
            ...
            <div class="btn-container" style="text-align: left;">
                ...
                <br />
                <br />
                <a href="<?php echo e(url('/tambahmurid')); ?>" class="btn btn-primary" style="text-decoration: none;">Back</a>
            </div>
        </form>
    </div>
</body>
</html>
<?php /**PATH D:\Program Files (x86)\XAMPP\htdocs\Tugas Campus\WEBPROG Real Backup 051123\UAS WebProg\UAS-WebProg\graciaweb-app\resources\views/crudsiswa.blade.php ENDPATH**/ ?>