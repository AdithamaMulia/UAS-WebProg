...
<div class="box-main">
    ...
    <h2 class="text-3xl font-bold text-blue-pigeon mt-3" style="padding-left: 15px;">Daftar Absen Siswa</h2>
        <br />
        <form id="absenForm" action="<?php echo e(url('/absensubmit/' . $kelas->kelasID)); ?>" method="post">
            <?php echo csrf_field(); ?>
            <div class="text-2l ml-2 font-sans" style="padding-left: 10px;"><?php echo e($kelas->tingkat); ?> <?php echo e($kelas->nama_kelas); ?></div>
            <br />
            <div class="input-container" style="padding-left: 15px;">
                <label for="tanggal">Tanggal: <?php echo e($absen->tanggal); ?></label>
                    ...
                    <thead class="thead-dark" style="background-color:black;">
                        ...
                        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($user->role == 'student'): ?>
                                <?php if($user->kelasID == $kelas->kelasID): ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input type="checkbox" id="userID" name="<?php echo e($user->userID); ?>">
                                        </td>
                                        <input type="hidden" name="kelasID" value="<?php echo e($kelas->kelasID); ?>">
                                        <td>
...
<?php /**PATH D:\Program Files (x86)\XAMPP\htdocs\Tugas Campus\WEBPROG Real Backup 051123\UAS WebProg\UAS-WebProg\graciaweb-app\resources\views/absen.blade.php ENDPATH**/ ?>