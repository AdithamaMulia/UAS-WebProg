    ...
    <section class="border-b py-8" style="background: linear-gradient(90deg, #edc7b7 0%, #eee2dc 100%);">
      <div class="container max-w-5xl mx-auto m-8">
        ...
        <div class="w-full sm:w-1/2 p-6 mt-6 flex" data-aos="slide-left">
          <img src="<?php echo e(asset('img')); ?>/siswa1.jpg" alt="laptop image" class="imgFluid1 ml-auto">
        </div>
      </div>
        ...
        <img src="<?php echo e(asset('img')); ?>/join-us.jpg" alt="laptop image" class="imgFluid1 ml-auto">
        </div>
    ...
    <section class="bg-white border-b py-8" style="background: linear-gradient(90deg, #edc7b7 0%, #eddbcc 100%);">
      <div class="container mx-auto flex flex-wrap pt-4 pb-12">
        ...
        <div class="flex items-center justify-start">
          <img src="<?php echo e(asset('img')); ?>/computer.jpg" alt="laptop image" class="imgFluid ml-auto">
        </div>
    </div>
        ...
        <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
          ...
          <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6" style="background-color: #edded1;">
        <div class="flex items-center justify-start">
        <img src="<?php echo e(asset('img')); ?>/sciencelab.jpg" alt="laptop image" class="imgFluid ml-auto">
        </div>
          </div>
        </div>
        <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
          ...
          <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6" style="background-color: #edded1;">
        <div class="flex items-center justify-start">
        <img src="<?php echo e(asset('img')); ?>/musicroom.jpg" alt="laptop image" class="imgFluid ml-auto">
        </div>
          </div>
        </div>
      </div>
...
<?php /**PATH D:\Program Files (x86)\XAMPP\htdocs\Tugas Campus\WEBPROG Real Backup 051123\UAS WebProg\UAS-WebProg\graciaweb-app\resources\views/index.blade.php ENDPATH**/ ?>