...
<a href="<?php echo e(url('/home')); ?>" class="ml-2 rounded px-2 py-1">
    ...
    <?php if($class): ?>
        <h3 class="text-2xl ml-2 font-sans"><strong><?php echo e($class->tingkat); ?> <?php echo e($class->nama_kelas); ?></strong></h3>
    <?php endif; ?>
    <?php endif; ?>
    <br />
    ...
    <tbody>
    <?php $__currentLoopData = $siswa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php if($user->role == 'student'): ?>
        <?php if($user->kelasID == $class->kelasID): ?>
            <tr>
    ...
    <a href="<?php echo e(url('/adminaddsiswa')); ?>" class="ml-2 border border-primary rounded px-2 py-1">
    ...
    <br />
    <a href="<?php echo e(url('/adminkelasindex')); ?>" class="ml-2 border border-primary rounded px-2 py-1">
    <i class="fa fa-arrow-left text-primary"></i>
        Back
    </a>
</body>
</html>
<?php /**PATH D:\Program Files (x86)\XAMPP\htdocs\Tugas Campus\WEBPROG Real Backup 051123\UAS WebProg\UAS-WebProg\graciaweb-app\resources\views/crudmurid.blade.php ENDPATH**/ ?>