...
<body style="background-color: #a4a4a4;">
    <div class="card">
        ...
        <?php endif; ?>
        <form action="<?php echo e(route('adminkelas.add')); ?>" method="post">
        <?php echo csrf_field(); ?>
...
<?php /**PATH D:\Program Files (x86)\XAMPP\htdocs\Tugas Campus\WEBPROG Real Backup 051123\UAS WebProg\UAS-WebProg\graciaweb-app\resources\views/tambahkelas.blade.php ENDPATH**/ ?>