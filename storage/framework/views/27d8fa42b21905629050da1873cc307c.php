...
<body>
    <div class="card">
        ...
        <form action="<?php echo e(route('adminmapel.update', ['mapelID' => $mapel->mapelID])); ?>" method="post"> 
            <?php echo csrf_field(); ?>
            <div class="form-group">
                <label for="nama_mapel">Mata Pelajaran</label>
                <input type="text" id="nama_mapel" name="nama_mapel" style="width: 100%; max-width: 280px;" placeholder="Nama Mapel" value="<?php echo e($mapel->nama_mapel); ?>" required>
            </div>
            <div class="form-group">
                <label for="kelasID">ID Kelas</label>
                <input type="text" id="kelasID" name="kelasID" style="width: 100%; max-width: 280px;" placeholder="ID Kelas" value="<?php echo e($mapel->kelasID); ?>" required>
...
<?php /**PATH D:\Program Files (x86)\XAMPP\htdocs\Tugas Campus\WEBPROG Real Backup 051123\UAS WebProg\UAS-WebProg\graciaweb-app\resources\views/editmapel.blade.php ENDPATH**/ ?>