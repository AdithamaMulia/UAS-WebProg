...
<div class="h-screen pb-14 bg-right bg-cover" style="background-image: url('<?php echo e(asset('img/bg.svg')); ?>');">
    ...
    <div class="container pt-24 md:pt-48 px-6 mx-auto flex flex-wrap flex-col md:flex-row items-center justify-center">
        <div class="flex flex-col w-full xl:w-2/5 justify-center lg:items-start h-96">
            <h1 class="my-4 text-3xl md:text-5xl text-purple-800 font-bold leading-tight text-center md:text-left slide-in-bottom-h1">Daftar Siswa dan Absensi Kelas <?php echo e($class->tingkat); ?> <?php echo e($class->nama_kelas); ?> </h1>
            ...
            <div class="flex flex-col md:flex-row w-full justify-center md:justify-start pb-24 lg:pb-0 fade-in">
                <div class="flex flex-col w-full md:w-1/2 lg:w-2/4 mb-4 md:mb-0">
                    <div class="col-lg-4 mb-3 mr-4">
                        <a href="<?php echo e(url('/listmurid/' . $class->kelasID)); ?>" class="card-link no-underline">
                ...
                <div class="flex flex-col w-full md:w-1/2">
                    <div class="col-lg-4 mb-3 mr-4">
                        <a href="<?php echo e(url('/absen/' . $class->kelasID )); ?>" class="card-link no-underline">
                            <div class="card" style="max-width: 100%; border: 2px solid #000; border-radius: 10px; box-shadow: 0px 8px 16px rgba(0, 0, 0, 0.2);">
                                <div class="card-body card-text-zoom" style="overflow: auto; padding: 20px;">
...
<?php /**PATH D:\Program Files (x86)\XAMPP\htdocs\Tugas Campus\WEBPROG Real Backup 051123\UAS WebProg\UAS-WebProg\graciaweb-app\resources\views/pilihan.blade.php ENDPATH**/ ?>