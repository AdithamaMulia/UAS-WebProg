...
<body>
    <h2>Welcome, Admin</h2>
    <a class="nav-link" href="<?php echo e(url('/home')); ?>" style="color: black;"><b>Home Page</b></a>
    ...
    <a href="<?php echo e(url('/adminpage7')); ?>">Add Data</a>
    <br />
    <a href="<?php echo e(url('/adminpage3')); ?>">Back</a>
</body>
</html><?php /**PATH D:\Program Files (x86)\XAMPP\htdocs\Tugas Campus\WEBPROG Real Backup 051123\UAS WebProg\UAS-WebProg\graciaweb-app\resources\views/crudnilai.blade.php ENDPATH**/ ?>