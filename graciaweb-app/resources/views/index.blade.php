...
<html lang="en">
  ...
  <div class="w-full sm:w-1/2 p-6 mt-6 flex flex-col justify-center">
  ...
  <div class="w-full sm:w-1/2 p-6 mt-6 flex">
    <img src="{{ asset('img') }}/siswa1.jpg" alt="laptop image" class="imgFluid ml-auto">
  </div>
</div>
        ...
        <div class="flex flex-wrap flex-col-reverse sm:flex-row">
        <div class="w-full sm:w-1/2 p-6 mt-6 flex">
        <img src="{{ asset('img') }}/join-us.jpg" alt="laptop image" class="imgFluid ml-auto">
        </div>
