...
<body>
        ...
        <nav class="flex justify-between items-center w-[92%] mx-auto">
            ...
            <div class="nav-links duration-500 md:static absolute bg-white md:min-h-fit min-h-[60vh] left-0 top-[-100%] md:w-auto w-full flex items-center px-5">
                <ul class="flex md:flex-row flex-col md:items-center gap-7">
                    <li>
                        <a class="hover:text-gray-500" href="<?php echo e(url('/student-information')); ?>">Student Information</a>
                    </li>
                    <li>
                        <a class="hover:text-gray-500" href="<?php echo e(url('/course')); ?>">Course Overview</a>
                    </li>
                    <li>
                        <a class="hover:text-gray-500" href="#contact">Contact Us</a>
                    </li>
                    <li>
                        <a class="hover:text-gray-500" href="<?php echo e(url('/about-us')); ?>">About Us</a>
                    </li>
                    <li>
                        <a class="hover:text-gray-500" href="<?php echo e(url('/enroll-now')); ?>">Enroll Now</a>
                    </li>
                </ul>
            </div>
    ...
    <section class="background firstSection">
        <div class="box-main">
            ...
            <div class="secondHalf">
                <img src="<?php echo e(asset('Img')); ?>/LogoSekolah.png" alt="">
            </div>
        </div>
    </section>
    <br />
    ...
    <section class="section">
        ...
        <div class="thumbnail">
            <img src="<?php echo e(asset('Img')); ?>/siswa2.jpg" alt="laptop image" class="imgFluid">
        </div>
    </section>
    ...
    <section class="section secLeft">
        ...
        <div class="thumbnail">
            <img src="<?php echo e(asset('Img')); ?>/sekolah1.jpg" alt="laptop image" class="imgFluid">
        </div>
    </section>
    ...
    <section class="section">
        ...
        <div class="thumbnail">
            <img src="<?php echo e(asset('Img')); ?>/join-us.jpg" alt="laptop image" class="imgFluid hack">
        </div>
    </section>
    <br/>
    <br/>
...
<?php /**PATH C:\xampp\htdocs\Webpro\UAS Webpro\resources\views/index.blade.php ENDPATH**/ ?>